...
cap = cv2.VideoCapture('beykoz.mp4')  # capture frames from a video

car_detection = cv2.CascadeClassifier('cars.xml')  # Trained XML classifiers describes some features of some object we want to detect
...
while True:
    ...
    cars = cars_detection = car_detection.detectMultiScale(gray, 1.1, 1)  # Detects cars of different sizes in the normal 1 1
    # input image
